...
public class NoiseGenerator {
    ...
    //================================== public methods ==================================
    /**
     * Constructor for a perlin noise generator
    ...
    /**
     * returns the value of perlin noise function according to the function
     * @param x the input to the function
     * @return value of the function at a given x value
     */
    ...
    /**
     * returns a smooth noise. this is a helper to the noise() functions
     * @param x value to be used in the calculation
     * @param y value to be used in the calculation
     * @param z value to be used in the calculation
    ...
    //================================== private methods ==================================
    /*
     * init method to be used in the constructor
     */
    private void init() {
